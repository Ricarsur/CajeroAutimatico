...
class Pantalla100k (QWidget):
    ...
    def retiro100k_gui(self):
        ...
        titulo = QLabel("Desea retirar 100.000?", self)
    ...
    def aceptar_retiro(self):
        ...
        alerta.setText("Dinero entregado: 1 billete de "+ str(retiro10)+ " 2 billetes de "+ str(retiro20)+ " 1 billete de "+str(retiro50))
